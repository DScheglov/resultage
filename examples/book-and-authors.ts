...
const getBookWithAuthors2 = (bookId: string): AsyncResult<
  Book & { authors: Person[] },
...
const fetchBook = async (id: string) => (
  id === '1' ? ok<Book>({ id, title: 'The Lord of the Rings', authorIds: ['1', '2'] }) :
  id === '2' ? ok<Book>({ id, title: 'The Silmarillion', authorIds: ['1', '3'] }) :
